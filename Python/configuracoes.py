...
try:
    ...
    print(f"ERRO: Arquivo 'api_keys.json' não encontrado na raiz ({DIRETORIO_RAIZ}).")
    sys.exit()
except json.JSONDecodeError:
    print("ERRO: Arquivo 'api_keys.json' está com o formato JSON inválido.")
    sys.exit()
...
def obter_recursos_sistema():
    ...
    try:
        ...
        if DEBUG_MODE: print("      [Aviso] Placa NVIDIA não detectada. Operando em modo de segurança.")
